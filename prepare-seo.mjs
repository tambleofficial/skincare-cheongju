...
for(const file of files){
 ...
 const business={'@context':'https://schema.org','@type':'BeautySalon','@id':base+'/#business','name':config.name,'url':base+'/','telephone':config.phone,'address':{'@type':'PostalAddress','streetAddress':config.address,'addressLocality':'청주시','addressRegion':'충청북도','addressCountry':'KR'},'sameAs':config.sameAs,'openingHoursSpecification':[{'@type':'OpeningHoursSpecification','dayOfWeek':['Monday','Tuesday','Wednesday','Thursday','Friday'],'opens':'10:00','closes':'20:00'},{'@type':'OpeningHoursSpecification','dayOfWeek':'Saturday','opens':'10:00','closes':'17:00'}]};
 const structured={'@context':'https://schema.org','@graph':[business,{'@type':'WebSite','@id':base+'/#website','url':base+'/','name':config.siteName,'alternateName':config.siteNameAlternate,'publisher':{'@id':base+'/#business'}}]};
