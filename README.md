# 더리파인 5개 홈페이지 — 수정본 사용 안내

## 이번 수정

- 사이트별 Home / About / Service / Portfolio / Contact, 총 25페이지 유지.
- 제공한 5개 메타 디스크립션 유지. 메타 타이틀, H1, 첫 화면 설명, 서비스 주제를 연결.
...
2. 청주피부관리 | 모공·아쿠아필·여드름 압출 케어 | 더리파인
3. 가경동 피부관리 | 청주터미널 프라이빗 에스테틱 | 더리파인
4. 청주 에스테틱 | 윤곽·이중턱·얼굴 탄력 피부관리 | 더리파인
5. 청주 에스테틱 | 웨딩·신부·데콜테 피부관리 | 더리파인

메인 페이지 설명은 제공된 5개 원문을 그대로 유지했습니다. 각 서브페이지 제목은 해당 사이트의 관리 주제와 페이지 역할에 맞춰 다르게 생성합니다. 메타 키워드만 넣는 방식이 아니라 방문자가 읽는 H1·첫 화면 설명·서비스에도 주제를 반영했습니다.
